...
<details>
  ...
  2. **Save the Script:**
     - Save the `fn_respawn_sectorControl_2.sqf` script in your mission's `arma3mercenaries/sector_control folder.
  ...
  3. **Configure the Sector Control Module:**
     ...
     ```sqf
     [_this select 0, _this select 1, _this select 2] execVM 'arma3mercenaries\sector_control\fn_respawn_sectorControl_2.sqf';
     ```
  ...
  2. **Save the Script:**
     - Save the `fn_respawn_sectorControl_1.sqf` script in your mission's `arma3mercenaries/sector_control folder.
  ...
  3. **Configure the Sector Control Module:**
     ...
     ```sqf
     [_this select 0, _this select 1, _this select 2] execVM 'arma3mercenaries\sector_control\fn_respawn_sectorControl_1.sqf';
     ```
